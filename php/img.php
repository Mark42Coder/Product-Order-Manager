...
imagestring($img, 5, 200, 10, $text, $black);
...
imagestring($img, 5, 3, 150,"     Item Name           |  Qty  | Price", $black);
...
imagestring($img, 5, 3, $items, "".substr($row["item_name"],0,25), $black);
imagestring($img, 5, 230, $items, "| ". $row["item_qty"], $black);
imagestring($img, 5, 300, $items, "| ". $row["item_price"], $black);
imagestring($img, 5, 230, $items, "| ", $black);
imagestring($img, 5, 300, $items, "| ", $black);
...
imagestring($img, 5, 10, $nl+5, "Note - ", $black);
/*
imagestring($img, 5, 10, $nl+18,substr($note,0,34), $black);
imagestring($img, 5, 10, $nl+36,substr($note,34,34), $black);
imagestring($img, 5, 10, $nl+54,substr($note,68,34), $black);
imagestring($img, 5, 10, $nl+72,substr($note,102,34), $black);
imagestring($img, 5, 10, $nl+90,substr($note,136,34), $black);
imagestring($img, 5, 10, $nl+108,substr($note,170,34), $black);
imagestring($img, 5, 10, $nl+126,substr($note,204,34), $black);
imagestring($img, 5, 10, $nl+144,substr($note,238,34), $black);
imagestring($img, 5, 10, $nl+162,substr($note,250,34), $black);
*/
imagestring($img, 5, 10, $nl+18, $note1, $black);
imagestring($img, 5, 10, $nl+36, $note2, $black);
imagestring($img, 5, 10, $nl+54, $note3, $black);
imagestring($img, 5, 10, $nl+72, $note4, $black);
imagestring($img, 5, 10, $nl+90, $note5, $black);
imagestring($img, 5, 10, $nl+108, $note6, $black);
imagestring($img, 5, 10, $nl+126, $note7, $black);
